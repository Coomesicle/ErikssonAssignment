...
namespace LoggingParser
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string logFilePath = Console.ReadLine() ?? string.Empty;
            ...
            if (!logs.Any())
            {
                Console.WriteLine($"No logs found, the log file: '{logFilePath}' may be invalid or empty.");
                return;
            }
        ...
        static List<Log> ParseLogs(string logFilePath)
        {
            ...
            while (line != string.Empty)
            {
                ...
                catch (Exception e)
                {
                    ...
                    Console.WriteLine($"Invalid Log Line '{line}', continuing to next line.");
                    Console.ResetColor();
                }
                line = file.ReadLine() ?? string.Empty;
            }
        ...
        static void DisplayEventOccurrences(List<Log> logs)
        {
            ...
            string eventChoice = Console.ReadLine() ?? string.Empty;
